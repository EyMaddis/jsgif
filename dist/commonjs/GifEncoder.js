...
var GifEncoder = function () {
  ...
  */
   ...
   */
		...
		key: 'encode',
		value: function encode(disposeUsedFrames) {
			var _this = this;

			return new Promise(function (resolve) {
				var timeout = void 0;
				var iterator = _this._encodingGenerator(disposeUsedFrames);
		...
		key: '_encodingGenerator',
		value: regeneratorRuntime.mark(function _encodingGenerator(disposeUsedFrames) {
			var gifWriter, imageEncoder, totalImages, currentImageIndex, _iteratorNormalCompletion, _didIteratorError, _iteratorError, _iterator, _step, image, _image, rgbaPixels, _image$, left, _image$2, top, _image$3, width, _image$4, height, _image$5, disposalMethod, _image$6, delayTime, _image$7, transparentColor, _imageEncoder$encodeI, _imageEncoder$encodeI2, localColorTable, transparentColorIndex, tableBasedImageData;

			return regeneratorRuntime.wrap(function _encodingGenerator$(_context) {
				while (1) {
